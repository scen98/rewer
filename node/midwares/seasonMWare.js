...
exports.deleteSeason = exports.insertSeason = void 0;
var movieQueries_1 = require("../models/movieQueries");
var seasonQueries_1 = require("../models/seasonQueries");
var midutils_1 = require("./midutils");
var movieMWare_1 = require("./movieMWare");
function insertSeason(req, res) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (req.body.seriesId == null)
                        return [2 /*return*/, midutils_1.returnMissingRequest(res, ["seriesId"])];
                    return [4 /*yield*/, midutils_1.withMysql(function (conn) { return __awaiter(_this, void 0, void 0, function () {
                            var newId;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, seasonQueries_1.insertSeasonQuery(conn, req.body)];
                                    case 1:
                                        newId = _a.sent();
                                        if (newId) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, midutils_1.withMysql(function (conn) { return __awaiter(_this, void 0, void 0, function () {
                            var episodes, result, _i, episodes_1, episode;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, movieQueries_1.selectDetailedMoviesBySeasonsQuery(conn, [req.body.id])];
                                    case 1:
                                        episodes = _a.sent();
                                        return [4 /*yield*/, seasonQueries_1.deleteSeasonQuery(conn, req.body.id)];
                                    case 2:
                                        result = _a.sent();
                                        if (result) {
                                            for (_i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
                                                episode = episodes_1[_i];
                                                movieMWare_1.deleteImages(episode.id + ".jpg");
                                            }
