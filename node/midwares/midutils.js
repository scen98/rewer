...
exports.checkLength = exports.isUserLogged = exports.isUserAdmin = exports.isUserMod = exports.validateProperties = exports.isImage = exports.getLimiter = exports.nullCheckLimit = exports.returnError = exports.return404 = exports.return500 = exports.return403 = exports.returnMissingRequest = exports.return400 = exports.return200 = exports.returnInsert = exports.return201 = exports.returnData = exports.asyncWrapper = exports.withMysql = exports.validateInput = void 0;
var mysqlConnection_1 = require("../config/mysqlConnection");
function validateInput() {
}
exports.validateInput = validateInput;
function withMysql(callback, callbackerr) {
    return __awaiter(this, void 0, void 0, function () {
        var mySqlConnection, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mySqlConnection = mysqlConnection_1.getConnection();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, callback(mySqlConnection)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3:
...
exports.isUserMod = function (req) {
    if (req.session == null)
        return false;
...
exports.isUserAdmin = function (req) {
    if (req.session == null)
        return false;
    if (req.session.user == null)
        return false;
...
exports.checkLength = function (res, text, max) {
    if (text.length > max) {
