...
import { MovieSliderM } from './MovieSliderM';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faAngleDoubleRight } from '@fortawesome/free-solid-svg-icons';
import { ELoaderStatus, ILoader, Load } from '../Load';

interface ILatestMoviesM{
}

export const LatestMovies: React.FC<ILatestMoviesM> = () => {
    ...
    return (
            <Load loader={loader}>
                <div className="highlight-grid">
                    <MovieSliderM movies={movies} onClick={(movie: IDetailedMovie)=> { setSelectedMovie(movie) }} selectedMovie={selectedMovie} />
                    <div className="highlighted-movie fade">
                        ...
                        <Link className="highlight-goto" to={`/rewer/movie?movieId=${selectedMovie.id}`}><FontAwesomeIcon icon={faAngleDoubleRight} /><FontAwesomeIcon icon={faAngleDoubleRight} /></Link>
                    </div>
                </div> 
            </Load>     
    )
